...
<section class="padding-common cta-banner">
    <div class="container position-relative cta-banner__inner">
        <div class="row gx-0 bg-primary text-white cta-banner__block">
            <div class="col-7 cta-banner__column">
                <div class="cta-banner__content">
                    <span class="d-block heading--span text-white cta-banner__subtitle">
...
<footer class="footer">
    <div class="bg-primary py-5 text-white footer__top">
                ...
                <div class="col-12 col-lg-6 footer__column">
                    <div class="footer__address">
                        ...
                        <p class="para text-white mb-3 footer__para">
                            ...
                            By Appointment Only WA1 4RF
                        </p>
                        <p class="para text-white mb-3 footer__para">
                            Phone: <a href="tel:01925943011">01925 943011</a>
                        </p>
                        <p class="para text-white mb-3 footer__para">
